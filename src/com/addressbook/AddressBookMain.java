...
public class AddressBookMain {
	...
	public static void main(String[] args)
		...
		while (option != 7) {
			...
			if (option != 2) {
				...
				System.out
						.println("**********Please enter the Addressbook name to save the contact to ******* ");
				System.out.println(
						"Family\nFriend\nBusiness");
	...
	public static int showMainMenu(Scanner sc) {
		System.out.println(
				"How would you like to continue???? \n*******Please select from the below options ***********\n 1.Add new contact \t 2.AddressBooks \t 3.delete current contact \t 4. Print contacts \t 5. Edit contact\t 6.Exit");
